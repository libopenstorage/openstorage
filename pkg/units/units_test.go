...
func TestString(t *testing.T) {
	...
	testString(t, uint64(units.KiB), "1 KiB")
	testString(t, uint64(units.MiB), "1 MiB")
	testString(t, uint64(units.GiB), "1.0 GiB")
	testString(t, uint64(units.TiB), "1.00 TiB")
	testString(t, uint64(units.PiB), "1.00 PiB")
}
