...
func (*UnimplementedAPIServer) Init(context.Context, *empty.Empty) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Init not implemented")
}
func (*UnimplementedAPIServer) Attach(context.Context, *AttachRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Attach not implemented")
}
func (*UnimplementedAPIServer) Detach(context.Context, *DetachRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Detach not implemented")
}
func (*UnimplementedAPIServer) Mount(context.Context, *MountRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Mount not implemented")
}
func (*UnimplementedAPIServer) Unmount(context.Context, *UnmountRequest) (*empty.Empty, error) {
