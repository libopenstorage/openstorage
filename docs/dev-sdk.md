...
* Enums
    ...
    * Wrap enums in messages so that their string values are clearer. Example see: TBD
    * Following the [Google protobuf style for enums](https://developers.google.com/protocol-buffers/docs/style#enums) 
* Messages
