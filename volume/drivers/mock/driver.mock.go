...
func (_m *MockVolumeDriver) FilesystemCheckCheckHealth(_param0 *api.SdkFilesystemCheckCheckHealthRequest) (*api.SdkFilesystemCheckCheckHealthResponse, error) {
	ret := _m.ctrl.Call(_m, "FilesystemCheckCheckHealth", _param0)
	ret0, _ := ret[0].(*api.SdkFilesystemCheckCheckHealthResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockVolumeDriverRecorder) FilesystemCheckCheckHealth(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "FilesystemCheckCheckHealth", arg0)
}

func (_m *MockVolumeDriver) FilesystemCheckCheckHealthGetStatus(_param0 *api.SdkFilesystemCheckCheckHealthGetStatusRequest) (*api.SdkFilesystemCheckCheckHealthGetStatusResponse, error) {
	ret := _m.ctrl.Call(_m, "FilesystemCheckCheckHealthGetStatus", _param0)
	ret0, _ := ret[0].(*api.SdkFilesystemCheckCheckHealthGetStatusResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockVolumeDriverRecorder) FilesystemCheckCheckHealthGetStatus(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "FilesystemCheckCheckHealthGetStatus", arg0)
}

func (_m *MockVolumeDriver) FilesystemCheckFixAll(_param0 *api.SdkFilesystemCheckFixAllRequest) (*api.SdkFilesystemCheckFixAllResponse, error) {
	ret := _m.ctrl.Call(_m, "FilesystemCheckFixAll", _param0)
	ret0, _ := ret[0].(*api.SdkFilesystemCheckFixAllResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockVolumeDriverRecorder) FilesystemCheckFixAll(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "FilesystemCheckFixAll", arg0)
}

func (_m *MockVolumeDriver) FilesystemCheckFixAllGetStatus(_param0 *api.SdkFilesystemCheckFixAllGetStatusRequest) (*api.SdkFilesystemCheckFixAllGetStatusResponse, error) {
	ret := _m.ctrl.Call(_m, "FilesystemCheckFixAllGetStatus", _param0)
	ret0, _ := ret[0].(*api.SdkFilesystemCheckFixAllGetStatusResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockVolumeDriverRecorder) FilesystemCheckFixAllGetStatus(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "FilesystemCheckFixAllGetStatus", arg0)
}
...
func (_m *MockVolumeDriver) SnapshotGroup(_param0 string, _param1 map[string]string, _param2 []string) (*api.GroupSnapCreateResponse, error) {
	ret := _m.ctrl.Call(_m, "SnapshotGroup", _param0, _param1, _param2)
	ret0, _ := ret[0].(*api.GroupSnapCreateResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockVolumeDriverRecorder) SnapshotGroup(arg0, arg1, arg2 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "SnapshotGroup", arg0, arg1, arg2)
}
