...
func (c *clusterApi) Routes() []*Route {
	return []*Route{
		...
		{verb: "GET", path: clusterVersion("checksecretlogin", cluster.APIVersion), fn: c.secretLoginCheck},
		{verb: "GET", path: clusterVersion("getsecret", cluster.APIVersion), fn: c.getSecret},
		{verb: "PUT", path: clusterVersion("setsecret", cluster.APIVersion), fn: c.setSecret},
		{verb: "POST", path: clusterVersion("setclustersecretkey", cluster.APIVersion), fn: c.setClusterSecretKey},
		{verb: "POST", path: clusterVersion("secretslogin", cluster.APIVersion), fn: c.secretsLogin},
	}
}
