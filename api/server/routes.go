...
func (c *clusterApi) Routes() []*Route {
	return []*Route{
		...
		{verb: "GET", path: clusterPath(client.UriSchedEnumerate, cluster.APIVersion), fn: c.schedPolicyEnumerate},
		{verb: "GET", path: clusterPath(client.UriSchedPolicy, cluster.APIVersion), fn: c.schedPolicyGet},
		{verb: "POST", path: clusterPath(client.UriSchedPolicy, cluster.APIVersion), fn: c.schedPolicyCreate},
		{verb: "PUT", path: clusterPath(client.UriSchedPolicy, cluster.APIVersion), fn: c.schedPolicyUpdate},
		{verb: "DELETE", path: clusterPath(client.UriSchedPolicy, cluster.APIVersion), fn: c.schedPolicyDelete},
