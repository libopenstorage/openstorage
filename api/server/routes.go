...
func (c *clusterApi) Routes() []*Route {
	return []*Route{
		...
		{verb: "POST", path: clusterServicePath("/drive", cluster.APIVersion), fn: c.serviceAddDrive},
		{verb: "PUT", path: clusterServicePath("/drive", cluster.APIVersion), fn: c.serviceReplaceDrive},
		{verb: "PUT", path: clusterServicePath("/entermaintenance", cluster.APIVersion), fn: c.serviceEnterMaintenanceMode},
		{verb: "PUT", path: clusterServicePath("/exitmaintenance", cluster.APIVersion), fn: c.serviceExitMaintenanceMode},
		{verb: "PUT", path: clusterServicePath("/rebalancepool", cluster.APIVersion), fn: c.serviceRebalancePool},
	}
}
