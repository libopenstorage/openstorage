...
func (c *ClusterManager) CreatePair(
	...
	response := &api.CreateClusterPairResponse{
...
func (c *ClusterManager) GetPair(
	...
	return &api.GetClusterPairResponse{
		PairInfo: pair,
	}, nil
}

func (c *ClusterManager) EnumeratePairs() (*api.EnumerateClusterPairsResponse, error) {
	response := &api.EnumerateClusterPairsResponse{}
	pairs, err := pairList()
	if err != nil {
		return nil, err
	}
